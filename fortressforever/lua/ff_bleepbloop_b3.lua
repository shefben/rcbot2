...
function robopack:dropatspawn() return false end

redrobopack = robopack:new({ touchflags = {AllowFlags.kRed} })
bluerobopack = robopack:new({ touchflags = {AllowFlags.kBlue} })

------------------------------------------------
-- Solly Pack
------------------------------------------------

robocells = genericbackpack:new({
	health = 25,
	armor = 50,
	grenades = 50,
	nails = 50,
...
function robocells:dropatspawn() return false end

redrobocells = robocells:new({ touchflags = {AllowFlags.kRed} })
bluerobocells = robocells:new({ touchflags = {AllowFlags.kBlue} })

--------------------------------------------------
--Grenade Pack
--------------------------------------------------

robonades = genericbackpack:new({
	health = 200,
	armor = 200,
	grenades = 90,
	nails = 90,
...
function robonades:dropatspawn() return false end
