...
typedef enum
{
	...
	// Fortress Forever Schedules
    SCHED_FF_PRIME_THROW_GRENADE,
    SCHED_FF_CONC_JUMP_SELF,
    SCHED_FF_HUNTED_ESCAPE,
    SCHED_FF_HUNTED_GUARD_VIP,
    SCHED_FF_ENGRI_BUILD_MANCANNON,
    SCHED_FF_DEMO_LAY_PIPE_TRAP,
    SCHED_FF_MEDIC_HEAL_TEAMMATE,
    SCHED_FF_SNIPE_ATTACK,
    SCHED_FF_DEMO_DETONATE_PIPES,
    SCHED_FF_PYRO_AIRBLAST_DEFEND,
    SCHED_FF_PYRO_EXTINGUISH_TEAMMATE,
    // New conceptual Engineer schedules
    SCHED_FF_ENGRI_BUILD_SENTRY,
    SCHED_FF_ENGRI_BUILD_DISPENSER,
    SCHED_FF_ENGRI_BUILD_PORTAL,
    SCHED_FF_ENGRI_REPAIR_BUILDING,
