...
typedef enum
{
 ...
 BOT_UTIL_SNIPE_CROSSBOW,
    ...
    // Fortress Forever Utilities
    BOT_UTIL_FF_USE_GRENADE_STD,
    BOT_UTIL_FF_USE_GRENADE_CONC,
    BOT_UTIL_FF_USE_GRENADE_NAIL,
    BOT_UTIL_FF_USE_GRENADE_MIRV,
    BOT_UTIL_FF_USE_GRENADE_EMP,
    BOT_UTIL_FF_USE_GRENADE_GAS,
    BOT_UTIL_FF_USE_GRENADE_CALTROP,
    BOT_UTIL_FF_CONC_JUMP_MOBILITY,
    BOT_UTIL_FF_HUNTED_VIP_ESCAPE,
    BOT_UTIL_FF_HUNTED_KILL_VIP,
    BOT_UTIL_FF_HUNTED_PROTECT_VIP,
    // Added based on defines from bot_ff.h and new conceptual ones
    BOT_UTIL_FF_ENGRI_BUILD_MANCANNON,
    BOT_UTIL_FF_ENGRI_BUILD_SENTRY,
    BOT_UTIL_FF_ENGRI_BUILD_DISPENSER,
    BOT_UTIL_FF_ENGRI_BUILD_PORTAL,
    BOT_UTIL_FF_ENGRI_REPAIR_BUILDING,
    BOT_UTIL_FF_DEMO_LAY_PIPE_TRAP,
    BOT_UTIL_FF_SPY_USE_TRANQ,
    BOT_UTIL_FF_PYRO_AIRBLAST,
    BOT_UTIL_FF_PYRO_USE_IC,
    BOT_UTIL_FF_DEMO_DETONATE_PIPES,
    BOT_UTIL_FF_GET_ARMOR,
    // BOT_UTIL_FF_SCOUT_USE_CALTROPS is consolidated with BOT_UTIL_FF_USE_GRENADE_CALTROP

 BOT_UTIL_MAX // Ensure this is always last for generic utilities
}eBotAction;
